# Icarus
Icarus est un projet créé durant le Web Basement (HTML) 2026 de la Haute-École Albert Jacquard. Le Web Basement est une jam organisée par l'option Interface Design Development de la HEAJ. Durant cette jam, nous avions une journée pour raconter adapter un conte dans un thème futuriste. 
...
- Nos propriétés CSS devaient obligatoirement être écrites en une seule ligne, sans espaces, pouvant donner ceci :
  
  ```
  body{margin:0;border:solid 1px white;background-color: #585858;font-family: "aboreto", sans-serif;font-weight: 400;font-style: normal;overflow-x: hidden;}
- Chacun de nos éléments présents sur le site devait avoir une bordure visible, cela va des images aux textes, en passant par nos sections ;
- Le jury devait présenter notre projet ;
- Sur la fin de la jam, on nous a également imposé un malus bonus : passer les claviers de notre groupe en QWERTY et finir le projet ainsi.

Nous avons aussi eu d'autres malus comme une direction artistique imposée dans les années 80 ou encore l'interdiction d'utiliser la propriété CSS `height`. Ces malus, nous avons décidé de les faire annuler grâce à la monnaie reçue durant l'événement.
